...
exports.updateUser = function(_app, _userId, _deviceId, _password, _notiId, _datas, done){
  console.log(_app,_userId,_deviceId);
  retrieveUser(_app, _userId, _deviceId, function(err,user,msg){
    ...
    if(_notiId) user.notiId   = _notiId;
    if(_datas) user.datas    = _datas;
...
exports.findUser = function(_app, _userId, _deviceId, datas, done){
  var query = {app: _app};
  if(_userId && _deviceId){
    //query.
  }
  User.findOne(
    {app: _app, userId: _userId, deviceId: _deviceId}, 
...
exports.searchUser = function (_app, _keys, _values, done){
    console.log(_app,_keys,_values);
  var query = {app: _app};
...
exports.storeMessages = function (_app, _channel, _name, _data, _users, /* _userId, _deviceId, */ done){
